/*
  ...
  - You are about to drop the column `sessinId` on the `Vote` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Vote_sessinId_pollId_key";

-- AlterTable
ALTER TABLE "Vote" DROP COLUMN "sessinId",
